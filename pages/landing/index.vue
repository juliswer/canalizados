            ...
            <nav class="main-nav">
              ...
              <ul class="nav">
                ...
                <li class="submenu">
                  ...
                  <ul>
                    <li><a href="" class="menu-item">Iniciá sesión</a></li>
                    <li><a href="" class="menu-item">Regístrate</a></li>
                    <li><a href="" class="menu-item">FAQ'S</a></li>
                    <li><a href="" class="menu-item">Comunidad</a></li>
                  </ul>
                </li>
                <li class="scroll-to-section">
        ...
        <div class="container">
          <div class="row">
            ...
            >
              ...
              <NuxtLink to="/"><a href="#about" class="main-button-slider">Conócenos mejor</a></NuxtLink>
            </div>
          </div>
        </div>
      </div>
