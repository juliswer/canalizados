...
<script>
import StaffPicks from '~/components/staffpicks/staffpicks.vue';
...
export default {
  components: { SidebarLeft, footerCanalizados, BodyCanalizados, HeaderCanalizados, LazyHydrate, StaffPicks},
  name: "homeLayout",
    data() {
    return {};
  },
